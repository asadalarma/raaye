                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-6" style="padding: 0 10px 0 0;">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="" name="city" required placeholder="City" value="<?= ($subcategory->city == 1) ? '' : $subcategory->city ?>">
                                <input type="checkbox" name="city" value="1" <?= ($subcategory->city == 1) ? 'checked' : '' ?>> All Cities
                            </div>
                        </div>
                        <div class="col-md-6" style="padding: 0;">
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Age :</label>
                                <input type="text" class="form-control" id="" name="age" required placeholder="Age" value="<?= ($subcategory->age == 1) ? '' : $subcategory->age ?>">
                            </div>
                            <input type="checkbox" name="city" value="1" <?= ($subcategory->age == 1) ? 'checked' : '' ?>> All Ages
                        </div>
