                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="well well-lg nobottommargin">
                            <form id="login-form" name="login-form" class="nobottommargin" action="{{ route('user-reset-password-submit') }}" method="post">
                                ...
                                <div class="col_full">
                                    ...
                                    <input id="username" name="email" class="form-control input-lg" type="email">
                                </div>
                                ...
                                <div class="col_full">
                                    ...
                                    <input id="password" name="password_confirmation" class="form-control input-lg" type="password">
                                </div>
