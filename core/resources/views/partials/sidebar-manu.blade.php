        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item  ">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">Survey Category</span>
            ...
            <li class="nav-item">
                <a href="{!! route('all-users') !!}" class="nav-link nav-toggle"><i class="fa fa-users"></i>
            ...
            <li class="nav-item  ">
                <a href="javascript:;" class="nav-link nav-toggle">
                    ...
                    <span class="title">Manage survey Question</span>
                    <span class="arrow"></span>
                </a>
                <ul class="sub-menu">
                    <li class="nav-item  ">
                        <a href="{{ route('question.index') }}" class="nav-link ">
                            <span class="title">All Survey Question</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ route('question.create') }}" class="nav-link ">
                            <span class="title">Create Survey Question</span>
                        </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item start">
                <a href="{{ route('survey-history') }}" class="nav-link nav-toggle">
                    <i class="fa fa-history" aria-hidden="true"></i>
                    <span class="title">Survey History</span>
                </a>
            </li>
            <li class="nav-item start">
                <a href="{{ route('withdraw-history') }}" class="nav-link nav-toggle">
                    <i class="fa fa-history" aria-hidden="true"></i>
            ...
            <li class="nav-item  ">
                ...
                <ul class="sub-menu">
                    <li class="nav-item  ">
                        <a href="{{ route('method-create') }}" class="nav-link ">
                            <span class="title">Add Method</span>
                        </a>
                    </li>
                    <li class="nav-item  ">
                        <a href="{{ route('method-show') }}" class="nav-link ">
                            <span class="title">Manage Method</span>
                        </a>
                    </li>
                </ul>
            </li>
